...
import {
  ...
  Alert, Button, Chip, Rating, Divider, Paper, Avatar
} from '@mui/material';
...
import { getVendorById } from '../api/axios';

const PLACEHOLDER = 'https://via.placeholder.com/800x400/f5e8e8/7a1c2e?text=No+Image';
      ...
      <Box sx={{ backgroundColor: '#1a0a0e', pb: 4, pt: { xs: 2, md: 4 } }}>
        <Container maxWidth="xl">
          <Button
            ...
            sx={{ color: 'rgba(255,255,255,0.7)', mb: 3, textTransform: 'none', fontFamily: '"Lato", sans-serif' }}
          >
            {t('common.back')}
          </Button>
              ...
              {images.map((img, i) => (
                <Box
                  ...
                  sx={{
                    ...
                    cursor: 'pointer',
                    flexShrink: 0,
                    border: i === activeImg ? '2px solid #c4576a' : '2px solid transparent',
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2, mb: 3 }}>
              <Box>
                <Chip
                  ...
                  size="small"
                  sx={{ backgroundColor: 'rgba(122,28,46,0.08)', color: '#7a1c2e', fontFamily: '"Lato", sans-serif', mb: 1 }}
                />
                <Typography
                  sx={{
                ...
                <Typography sx={{ fontFamily: '"Lato", sans-serif', color: '#888', mt: 0.5 }}>
                  {vendor.district}
                </Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <Rating value={vendor.rating || 0} readOnly precision={0.5} sx={{ color: '#c4576a' }} />
                <Typography sx={{ fontFamily: '"Cormorant Garamond", serif', fontSize: '1.3rem', fontWeight: 700 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mb: 3 }}>
                {vendor.owner_name && (
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Avatar sx={{ width: 32, height: 32, backgroundColor: 'rgba(122,28,46,0.1)' }}>
                      <PersonIcon sx={{ fontSize: 16, color: '#7a1c2e' }} />
                    </Avatar>
                    <Box>
                      <Typography sx={{ fontFamily: '"Lato", sans-serif', fontSize: '0.75rem', color: '#888' }}>
                        {t('vendor.owner')}
                      </Typography>
                      <Typography sx={{ fontFamily: '"Lato", sans-serif', fontWeight: 600, fontSize: '0.9rem' }}>
                        {vendor.owner_name}
                      </Typography>
                    </Box>
                  </Box>
                ...
                {vendor.experience && (
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                    <Avatar sx={{ width: 32, height: 32, backgroundColor: 'rgba(122,28,46,0.1)' }}>
                      <WorkHistoryIcon sx={{ fontSize: 16, color: '#7a1c2e' }} />
                    </Avatar>
                    <Box>
                      <Typography sx={{ fontFamily: '"Lato", sans-serif', fontSize: '0.75rem', color: '#888' }}>
                        {t('vendor.experience')}
